...
export interface Vehicle {
  ...
  tyre_fl_brand: string | null;
  tyre_fl_dot_code: string | null;
  tyre_fr_spec: string | null;
  tyre_fr_brand: string | null;
  tyre_fr_dot_code: string | null;
  tyre_rl_spec: string | null;
  tyre_rl_brand: string | null;
  tyre_rl_dot_code: string | null;
  tyre_rr_spec: string | null;
  tyre_rr_brand: string | null;
  tyre_rr_dot_code: string | null;
